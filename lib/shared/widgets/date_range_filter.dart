  ...
  Widget build(BuildContext context) {
    ...
    if (selectedRange == null) {
      ...
      if (selectedRange!.start.year == selectedRange!.end.year && 
         ...
         displayLabel = '${dateFormat.format(selectedRange!.start)} - ${dateFormat.format(selectedRange!.end)}';
      }
    }
    ...
    return InputChip(
      ...
      avatar: PhosphorIcon(
        ...
        size: 16,
        color: selectedRange == null ? colorScheme.onSurface : colorScheme.primary,
      ),
      ...
      backgroundColor: selectedRange == null ? colorScheme.surface : colorScheme.primaryContainer.withValues(alpha: 0.3),
      side: BorderSide(
        color: selectedRange == null ? colorScheme.outline.withValues(alpha: 0.3) : colorScheme.primary,
      ),
      onPressed: () async {
      ...
      deleteIcon: selectedRange != null ? PhosphorIcon(PhosphorIconsRegular.x, size: 14) : null,
